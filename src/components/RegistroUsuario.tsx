...
export const RegistroPokemon: React.FC = () => {
    const { registrarEntrenador, entrenadores, entrenadorActivo, seleccionarEntrenador } = usePokemon();
                    ...
                    <div>
                        {entrenadores.map((user) => (
                            <button
                                ...
                                style={{
                                    backgroundColor: entrenadorActivo?.id === user.id ? '#ff00fff6' : '#e3e3e3',
                                    color: entrenadorActivo?.id === user.id ? 'black' : '#000',
                                    padding: '6px 12px',
                                }}>{user.nombreCompleto}
                            </button>
                        ))}
